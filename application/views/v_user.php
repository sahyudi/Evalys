          ...
          <form class="form-horizontal" id="user_form" validate="true" method="POST">
            <div class="box-body">
              ...
              <div class="form-group">
                <label class="col-md-2 control">NIK *</label>
              ...
              <tbody>
                ...
                ?>
                  <tr>
                    <td><?= $no ?></td>
                    <td>
                      <button type="button" id="btn_id" class="btn  btn-success btn-sm btn_id" value="<?= $temp->id ?>" data-toggle="modal" data-target="#modal-info">
                        <i class="fa fa-pencil fa-sm"></i>
                      </button>
                      <button type="button" class="btn  btn-danger btn-sm" value="<?= $temp->id ?>" onclick="user_delete(<?= $temp->id ?>)">
