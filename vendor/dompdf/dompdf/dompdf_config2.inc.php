<?php
	 ...
	 * Created by 	: Sudirman
	 * Requested by	: -
	 * Date			: 12th Oktober 2018
	 * Description  : Pembantu untuk merubah font dalam pdf
	 */
...
if ( file_exists(DOMPDF_DIR . "/dompdf_config2.custom.inc.php") ){
  require_once(DOMPDF_DIR . "/dompdf_config2.custom.inc.php");
}
